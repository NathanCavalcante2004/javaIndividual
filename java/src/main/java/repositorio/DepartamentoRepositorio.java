...
public class DepartamentoRepositorio {
    ...
    public  List <Departamento> buscarDepartamentoHospital(int hospital){
           return conn.query("select * from departamento where fkHospital = " + hospital,new BeanPropertyRowMapper<>(Departamento.class));
